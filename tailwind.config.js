module.exports = {
  ...
  theme: {
    ...
    boxShadow: {
      nav: "0px 6px 10px rgba(0, 0, 0, 0.04)",
      wlb: "0px 15px 30px rgba(74, 85, 104, 0.15)",
      ...
      lg: "0px 0px 26px 3px rgba(0,0,0,0.4)",
      xl:
        "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)",
      "2xl": "0 25px 50px -12px rgba(0, 0, 0, 0.25)",
      inner: "inset 0 2px 4px 0 rgba(0, 0, 0, 0.06)",
      outline: "0 0 0 3px rgba(66, 153, 225, 0.5)",
      outlineinput: "0 0 0 2px rgba(130, 130, 130, 1) inset",
      outlineerror: "0 0 0 2px rgba(228, 1, 115, 1) inset",
      selected: "0 0 0 0px #fff, 0 0 0 4px #68d391",
      none: "none",
    },
    container: {},
    cursor: {
    ...
    gridTemplateColumns: {
      none: "none",
      "items-table": "2fr 2fr 2fr 3fr 1fr",
